...
| Unit Testing | To code to combine the assigned label and the user's name | 1)🦋 Please enter your name or a name that you want to be referred🦋 2) 🦋 Now please choose a label for yourself. This will stick your name throughout the game🦋  🧚 press 1 for fairy  🧙‍ press 2 for witch   🧛 press 3 for vampire | 1)Beril 2)1 | Your username will be 🧚fairyberil|SUCCESFUL|
## Non-Functional Testing
The recevived feedback from the MVP beta user made me realise that there was a bug at the intro part of the code. Also the beta tester said that the menu with the icons and the theme of the game was good.
